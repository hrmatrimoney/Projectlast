    ...
    <div class="flex flex-wrap">
      <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        ...
        <p class="text-gray-500 mb-6">
         We're friendly and available to chat. Reach out to us anytime ans we'll happily answer your questions </p>
        <p class="text-gray-500 mb-2">Chandigarh,+91-9896862074 , India</p>
        <p class="text-gray-500 mb-2">+91-7973756629</p>
        <p class="text-gray-500 mb-2">pawankumar6438@gmail.com</p>
      </div>
